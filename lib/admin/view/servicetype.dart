...
class ServiceTypes extends StatefulWidget
{
  ...
  const ServiceTypes({Key? key,}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:    AppBarr( foodtitle:'Service Types',),
        leading: LeadingAppBar(),
        actions: [

          ActionsWidget(onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => AddServiceType(),),);},),
